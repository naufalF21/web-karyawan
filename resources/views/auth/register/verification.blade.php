...
@section('content')
    ...
    <div class="d-flex flex-column align-items-center justify-content-center w-100" style="height: 100vh">
        <div class="d-flex flex-column text-start m-auto justify-content-center align-items-center">
            ...
            <span class="fw-normal text-center mt-2 mb-4 w-60" id="text">Your request is being reviewed, while waiting
                for approval from admin please check your email for a verification link.
                <br>Thank You.</span>
            <div>
