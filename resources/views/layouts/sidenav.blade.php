            ...
            <div class="nav">
                ...
                <div class="nav-item">
                    <a href="{{ route('dashboard.absen') }}"
                        class="btn fw-normal rounded-pille text-start w-100 ps-4 mt-2 {{ Route::is('dashboard.absen') ? 'btn-primary text-white' : 'btn-light text-black' }}">
                        <svg class="mr-1 mb-1" xmlns="http://www.w3.org/2000/svg" width="21" height="20"
                            ...
                            <path
                                ...
                                stroke="{{ Route::is('dashboard.absen') ? 'white' : 'black' }}" stroke-width="1.2"
                ...
                <div class="nav-item">
                    <a href="{{ route('dashboard.employees') }}"
                        class="btn fw-normal rounded-pille text-start w-100 ps-4 mt-2 {{ Route::is('dashboard.employees') ? 'btn-primary text-white' : 'btn-light text-black' }}">
                        <svg class="mr-1 mb-1" width="21" height="20" viewBox="0 0 21 20" fill="none"
                            ...
                            <path
                                ...
                                stroke="{{ Route::is('dashboard.employees') ? 'white' : 'black' }}" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                stroke="{{ Route::is('dashboard.employees') ? 'white' : 'black' }}"
